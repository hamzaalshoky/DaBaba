package net.dylanvhs.dababa;

import net.dylanvhs.dababa.block.ModBlocks;
import net.dylanvhs.dababa.entity.ModEntityTypes;
import net.dylanvhs.dababa.entity.client.DaBabaRenderer;
import net.dylanvhs.dababa.entity.client.PampamRenderer;
...
@Mod(DaBabaMod.MOD_ID)
public class DaBabaMod
{
    public static final String MOD_ID = "dababa";
    ...
    private void clientSetup(final FMLCommonSetupEvent event){
        EntityRenderers.register(ModEntityTypes.DA_BABA.get(), DaBabaRenderer::new);
        EntityRenderers.register(ModEntityTypes.PAMPAM.get(), PampamRenderer::new);
